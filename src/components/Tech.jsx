import { BiLogoCss3, BiLogoGit, BiLogoGithub, BiLogoHtml5, BiLogoJavascript, BiLogoMongodb, BiLogoNodejs, BiLogoPostgresql, BiLogoPython, BiLogoReact, BiLogoTailwindCss, BiLogoTypescript, BiLogoVisualStudio } from "react-icons/bi"
    ...
    <div id="tech" className="flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32">
      ...
      <div className="flex flex-wrap items-center justify-center gap-10 p-5">
        ...
        <motion.div
               ...
               transition={{duration:0.5}}
        >
          <BiLogoGit className="cursor-pointer text-[80px] text-orange-500  transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div
               ...
               transition={{duration:0.5}}
        >
          <BiLogoVisualStudio className="cursor-pointer text-[80px] text-blue-500  transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
